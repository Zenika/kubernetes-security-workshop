...
def destroy_infra(team_name, password):
    organization = os.environ.get('ORGANIZATION_ID')
    print(subprocess.check_output(['terraform', 'destroy', 
        '-auto-approve',
    ...
    def run(self):
        while True:
            ...
            try:
                ...
                destroy_infra(team_name, password)
                print('team_name: {}'.format('Environment destroyed'))
            finally:
